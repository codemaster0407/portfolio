            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row justify-between items-start">
                  ...
                  <div className={`${darkMode ? 'bg-sky-800 text-white' : 'bg-sky-100 text-sky-800'} px-3 py-1 rounded-full text-sm mt-2 md:mt-0 whitespace-nowrap`}>
                    Sep 2025 – Sep 2026
                  </div>
                </div>
                ...
                <div className={`p-4 rounded-lg mt-4 ${darkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {mscCourses.map((course, index) => (
                      <div
                        key={index}
                        className={`p-3 rounded ${darkMode ? 'bg-gray-700 text-white' : 'bg-white text-gray-800'} shadow`}
                      >
                        {course}
                      </div>
                    ))}
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row justify-between items-start">
                  ...
                  <div className={`${darkMode ? 'bg-sky-800 text-white' : 'bg-sky-100 text-sky-800'} px-3 py-1 rounded-full text-sm mt-2 md:mt-0`}>
                    Sep 2020 – Aug 2024
                  </div>
                </div>
